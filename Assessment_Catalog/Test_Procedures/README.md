...
- **Artifacts:** {Links to relevant artifacts in ../Artifacts/}
- **Controls:** {Links to implementation descriptions in ../Controls/}
- **Observations:** {Links to observation files in ../Observations/}
```
