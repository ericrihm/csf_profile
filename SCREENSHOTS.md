...
![Requirements Overview](public/screenshots/requirements-overview.png)

### Assessment Observations Panel

The detail panel includes quarterly assessment observations with:
- In Scope toggle
- Owner and Stakeholder assignment
- Auditor assignment
- Testing status and observation date
- Assessment methods (Examine, Interview, Test)
- Linked artifacts
- Actual and Target scores

![Requirements Detail Panel](public/screenshots/requirements-detail.png)
...
![Assessment Observations](public/screenshots/observations.png)
...
![Remediation Plans](public/screenshots/remediation.png)
