...
Maturity scores, gaps, and remediation plans belong in [Observations](../4_Observations/), not here. Controls describe *what is implemented*, observations describe *what was found*.
...
- [{Artifact name}](../../5_Artifacts/{Type}/{filename}.md)
```
